(() => {
    ...
    function trackScroll() {
        const arrowScroll = window.scrollY;
        const coord = document.documentElement.clientHeight;
        if (arrowScroll > coord) arrow.classList.add("arrow--active"); else arrow.classList.remove("arrow--active");
    }
    function goTop() {
        if (window.scrollY > 0) {
